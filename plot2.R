...
if (memory.size() < size.estimate) {
  ...
  with(selectedData,plot(dates_time,Global_active_power,xaxt="n",type = "l",lwd=2,ylab="Global Active Power (kiliwatts)",xlab = "Day")) # do not plot the x axis
  title(main = "Global Active Power per day")
